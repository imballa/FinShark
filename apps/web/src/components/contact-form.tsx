    ...
    return (
      <Container width="tight">
        <StaticImage
          ...
          height={768}
        />
        <p className="text-3xl mt-6 text-center sm:text-4xl leading-normal font-extrabold tracking-tight">
    ...
    <div className="max-w-screen-lg mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-12 shadow-md">
        <div className="bg-finBlue text-white md:col-span-4 p-10">
          <h2 className="text-3xl sm:text-4xl leading-normal font-extrabold tracking-tight">
          ...
          <div className="flex items-center mt-5">
            ...
            <a href="https://www.google.fr/maps/dir//Rajhans+Complex,+Jay+Prakash+Narayan+Marg,+Sagrampura,+Surat,+Gujarat+395008">
              <span className="text-sm underline">
                <span className="font-bold">Head Office: </span>309, Rajhans
                Complex, Besides Nirmal Hospital, Ring Road, Surat - 395002
              </span>
            </a>
          </div>
          <div className="flex items-center mt-5">
            ...
            <span className="text-sm underline">
              <span className="font-bold">Branch Office: </span>302, A Wing,
              Devgiri Apartment, Sinhagad Road, Pune - 411030
            </span>
          </div>
          <div className="flex items-center mt-5">
            <svg
            ...
            <a href="tel:+919328673689">
              <span className="text-sm underline">+91 9328673689</span>
            </a>
          </div>
          <div className="flex items-center mt-5">
            <svg
            ...
            <a href="mailto:office@finshark.in">
              <span className="text-sm underline">office@finshark.in</span>
            </a>
          </div>
        </div>
